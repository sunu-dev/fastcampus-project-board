...
class ArticleControllerTest {
    ...
    @Test
    public void given_whenRequestingArticleSearchView_thenReturnArticlesSearchView() throws Exception {
        // Given
  ...
  @DisplayName("[view][GET] 게시글 해시태그 검색 페이지 - 정상호출")
    @Test
    public void given_whenRequestingArticleHashtagSearchView_thenReturnArticlesHashtagSearchView() throws Exception {
        // Given
